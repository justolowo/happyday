...
You can download the original R notebook document for this page [HERE](http://spatial.binghamton.edu/geog533/notebook/Lecture_W07_ContinuousProbability.nb.html).
...
ras2 <- ras + ras * 10
plot(ras2)
writeRaster(ras2,filename = "output/test.tif",overwrite=TRUE)
